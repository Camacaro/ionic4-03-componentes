...
const routes: Routes = [
  ...
  { path: 'infinited-scroll', loadChildren: './pages/infinited-scroll/infinited-scroll.module#InfinitedScrollPageModule' },
  ...
  // para que no se pueda acceder a traves de la URL
